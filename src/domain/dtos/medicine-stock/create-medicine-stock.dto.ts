...
export class CreateMedicineStockDto {
    ...
    static create( object: { [key: string]: any } ): [string?, CreateMedicineStockDto?] {

        const { name, image, quantity, manufacturer, unitOfMeasure, quantityPerUnit, isActive } = object;
        ...
        return [undefined, new CreateMedicineStockDto(name, image, quantity, manufacturer, unitOfMeasure, quantityPerUnit, isActive)];
